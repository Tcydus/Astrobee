...
//        viaMove(11.00f, -7.15f, 5.44f, 0.0f, 0.0f, 0.707f, -0.707f);
        ...
        String pos_qy = GotoQR(11.42, -8.04, 5.4, 0.0, 0.0, 0.0,1.0);
        api.judgeSendDiscoveredQR(4,pos_qy);
        String pos_qz = GotoQR(10.45, -7.66, 5.47, 0.707f, 0.0f, 0.707f,0.0f);
        api.judgeSendDiscoveredQR(5,pos_qz);
        String pos_qx = GotoQR(10.38, -7.46, 4.78, 0.0, 0.0, 1.0,0.0);
